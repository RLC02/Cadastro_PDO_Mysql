        ...
        <div class="formulario">
            <form method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control" name="endere" value="<?php echo $row->endereco;  ?>"
                        id="endere" required></input>
                </div>
                <div class="mb-4">
                    <label for="bairro" class="form-label">Bairro:</label>
                    <input type="text" class="form-control" id="bairro" value="<?php echo $row->bairro;  ?>"
                        name="bairro" required></input>
                </div>
                <div class="mb-4">
